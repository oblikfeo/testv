...
return [
    ...
    'endpoints' => [
        [
            'key' => 'vless-yandex-nl',
            'type' => 'vless',
            'happ_label' => env('NODE_A_HAPP_LABEL', 'Обход глушилок'),
        ...
        [
            'key' => 'vless-nl',
            'type' => 'vless',
            'happ_label' => env('NODE_C_HAPP_LABEL', 'Нидерланды'),
        ...
        [
            'key' => 'vless-ru-wifi',
            'type' => 'vless',
            'happ_label' => env('NODE_F_HAPP_LABEL', 'Быстрая скорость Wi-Fi'),
            'host' => env('NODE_F_HOST', '195.133.17.68'),
            'port' => (int) env('NODE_F_VLESS_PORT', 443),
            'vless_uuid' => env('NODE_F_VLESS_UUID', 'ed48a592-96f2-4cb7-b006-7241823e37ea'),
            'reality_pbk' => env('NODE_F_REALITY_PBK', 'fYch5iE-QIjBSsKvMjpzbIUhGmHvAKdCoem0dtnexXk'),
            'reality_sid' => env('NODE_F_REALITY_SID', 'a1b2c3d4'),
            'reality_sni' => env('NODE_F_REALITY_SNI', 'www.microsoft.com'),
            'reality_fp' => env('NODE_F_REALITY_FP', 'chrome'),
            'reality_flow' => env('NODE_F_REALITY_FLOW', 'xtls-rprx-vision'),
            'reality_spx' => env('NODE_F_REALITY_SPX', '/'),
        ],
    ],
