...
@section('title', 'AVA VPN — быстрый и приватный VPN для России | Бесплатный тест 3 часа')
@section('meta_description', 'AVA VPN — надёжный VPN-сервис для России: высокая скорость, защита от блокировок, простое подключение на телефон, компьютер и роутер. Тестовый доступ на 3 часа бесплатно, без банковской карты.')
@section('og_title', 'AVA VPN — быстрый VPN-сервис для России')
@section('og_description', 'Высокая скорость, стабильное соединение, защита приватности. 3 часа бесплатно — без карты и регистрации по номеру.')
    ...
    <script type="application/ld+json">
    {
        ...
        "mainEntity": [
            ...
            },
            {
                ...
                "acceptedAnswer": {
                    "@@type": "Answer",
                    "text": "Да, при регистрации мы выдаём тестовый доступ на 3 часа абсолютно бесплатно. Банковская карта не требуется — нужен только email."
                }
            },
            {
                "@@type": "Question",
        ...
        <div class="container hero-inner">
            ...
            <div class="hero-cta reveal" style="--reveal-delay: 180ms">
                ...
                @else
                    ...
                    <span class="hint">3 часа без оплаты. Карта не нужна.</span>
                @endauth
            </div>
            @php
            ...
            @if ($channelUrl !== '' || $botUrl)
                <div class="hero-cta hero-cta-social reveal" style="--reveal-delay: 210ms;">
                    @if ($channelUrl !== '')
                        <a href="{{ $channelUrl }}" target="_blank" rel="noopener" class="btn btn-secondary btn-lg" style="display:inline-flex;align-items:center;gap:10px;">
                    ...
                    @endif
                    @if ($botUrl)
                        <a href="{{ $botUrl }}" target="_blank" rel="noopener" class="btn btn-secondary btn-lg" style="display:inline-flex;align-items:center;gap:10px;">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0h-.056zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>
                            <span>ТГ-бот</span>
                        </a>
                    @endif
        ...
        <div class="container">
            ...
            <div class="faq-list reveal">
                ...
                <details class="faq-item">
                    ...
                    <div class="faq-a">
                        <p>Да, при регистрации мы&nbsp;выдаём тестовый доступ на&nbsp;3 часа абсолютно бесплатно. Банковская карта не&nbsp;требуется — нужен только email.</p>
                    </div>
                </details>
