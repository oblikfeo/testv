...
<div class="bg-gray-800 rounded-xl p-6">
    ...
    <div class="text-gray-400 space-y-2 text-sm">
        <p>Все активные подписки и триал получают подписку из <code class="text-gray-300">SHARED_HY2_URI</code> + <code class="text-gray-300">SHARED_VLESS_URI</code> (URL <code class="text-gray-300">/sub/…</code>).</p>
