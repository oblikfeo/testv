...
export default function PersonalData() {
    return (
        <LandingLayout title="AVA VPN — Политика обработки персональных данных" footerVariant="legal">
            <AgreementLayout title="Политика обработки персональных данных" dateLabel="Редакция от 14.04.2026">
