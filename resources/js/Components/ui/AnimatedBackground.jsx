    ...
    if (variant === 'hero') {
        return (
            <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
                ...
                <div className="absolute -top-32 left-[15%] h-[34rem] w-[34rem] rounded-full bg-red-600/40 blur-[90px] animate-float" />
                <div className="absolute top-0 right-[10%] h-[28rem] w-[28rem] rounded-full bg-fuchsia-600/30 blur-[90px] animate-float-slow" />
            </div>
        );
    }
